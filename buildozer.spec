...
version = 1.3.2
requirements = android, hostpython3==3.9.6, python3==3.9.6, werkzeug==2.3.7, flask==2.1.3, kivy, kivymd, certifi>=2018.4.16, pillow, sqlite3, jnius, requests, urllib3, charset-normalizer==3.0.1, idna==3.4, chardet, pytz, oscpy
